...
// hasSocial also accepts social_not_available -- a school where a human has
// confirmed there's genuinely no Twitter/X or Facebook for the head coach
// (set from the school profile's Quick Fix panel). Without this, a
// social-media-less program would look identical to one nobody has ever
// checked (both just have blank hc_twitter/hc_facebook), and would never
// be able to register as "fully worked" no matter how much verification
// staff did on it.
