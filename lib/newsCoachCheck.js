...
- A new Athletic Director being hired or announced is NOT a head football coaching change, even at the same school in the same article -- the AD is a different position. Only set change_detected true when the result specifically names a new HEAD FOOTBALL COACH, not just a new AD overseeing the athletics program.
